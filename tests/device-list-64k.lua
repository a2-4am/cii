...
--[[
  This tests displaying the list of available devices on a //e without an extended 80-column card. The device list should be identical to the one offered by v8.4 under the same configuration.
]]
...
test.Step(
  "Device list on 64K //e matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
    ...
    test.Expect(not cii.ScreenContains("SLOT 3"), "Device list includes unexpected device in slot 3")
