...
--[[
  This tests that C2Reboot displays an error message when attempting to rename files on an unformatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "Rename Files on unformatted disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
