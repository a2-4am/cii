...
--[[
  This tests View Files as Text on an Integer BASIC file from a DOS 3.3 formatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "View Files as Text on Integer BASIC file (DOS 3.3) matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
    ...
    test.ExpectIMatch(apple2.GrabTextScreen(), "N]PRONTO%-DOS", "View Files as Text behavior does not match v8.4")
    test.ExpectIMatch(apple2.GrabTextScreen(), "DEMO%)0XUYV1W1{YY", "View Files as Text behavior does not match v8.4")
