...
--[[
  This tests that C2Reboot does not detect any bad sectors when attempting to verify a disk with no bad sectors, matching v8.4 behavior.
]]
...
test.Step(
  "Verify disk (DOS 3.3) with no bad sectors matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
