...
--[[
  This tests View Files as Text on a text file from a DOS 3.3 formatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "View Files as Text on text file (DOS 3.3) matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
