...
--[[
  This tests that C2Reboot displays an error message when attempting to view files as values on a blank (formatted but all-0s) 3.5-inch (800K) disk, matching v8.4 behavior.
]]
...
test.Step(
  "View Files as Values on blank 800K disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
