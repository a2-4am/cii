...
test.Step(
  "Device list on IIgs matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
    ...
    test.Expect(cii.ScreenContains("SLOT 5  DRIVE 1"), "Device list does not include expected device s5d1")
    test.Expect(cii.ScreenContains("SLOT 5  DRIVE 2"), "Device list does not include expected device s5d2")
