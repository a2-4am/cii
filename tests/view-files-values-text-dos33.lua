...
--[[
  This tests View Files as Values on a text file from a DOS 3.3 formatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "View Files as Values on text file (DOS 3.3) matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
    ...
    test.ExpectIMatch(apple2.GrabTextScreen(), "C9 C6 A0 D0 C5 C5 CB A8  IF PEEK%(", "View Files as Values behavior does not match v8.4")
    test.ExpectIMatch(apple2.GrabTextScreen(), "C2 CC CF C1 C4 A0 C7 D0  BLOAD GP", "View Files as Values behavior does not match v8.4")
