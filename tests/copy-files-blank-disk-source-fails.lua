...
--[[
  This tests that C2Reboot displays an error message when attempting to copy files from a blank (formatted but all-0s) disk, matching v8.4 behavior.
]]
...
test.Step(
  "Copy Files from blank disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
    apple2.Type("X") -- Copy
