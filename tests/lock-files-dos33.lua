...
--[[
  This tests Lock Files on a DOS 3.3 disk. The operation should succeed, matching v8.4 behavior. C2Reboot matches v8.4 with the exact contents of the VTOC and all directory sectors.
]]

--[[ BEGINCONFIG ========================================

  MODELARGS="-sl5 'diskiing'"
  DISKARGS="-flop1 'DOS 3.3 System Master.do' -flop3 $FLOPIMG -flop4 'DOS 3.3 System Master-unlocked-by-v84.do'"
...
test.Step(
  "Lock Files (DOS 3.3) matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
    ...
    test.ExpectBinaryEquals(util.SlurpFile(actual_filename),
                            ...
                            "Lock Files (DOS 3.3) disk image differs from v8.4")
end)
