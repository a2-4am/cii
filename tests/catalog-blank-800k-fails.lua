...
--[[
  This tests that C2Reboot displays an error message when attempting to cataloga blank (formatted but all-0s) 3.5-inch (800K) disk, matching v8.4 behavior.
]]
...
test.Step(
  "Catalog blank 800K disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
