...
--[[
  This tests that C2Reboot displays an error message when attempting to verify files on a non-existent 3.5-inch (800K) disk, matching v8.4 behavior.
]]
...
test.Step(
  "Verify files on non-existent 800K disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
