...
--[[
  This tests that C2Reboot displays an error message when attempting to Rename Volume on an unformatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "Rename Volume on unformatted disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
