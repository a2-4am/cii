...
--[[
  This tests View Files as Values on a text file from a ProDOS formatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "View Files as Values on text file (ProDOS) matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
    ...
    test.ExpectIMatch(apple2.GrabTextScreen(), "61 74 69 62 75 73 20 65  atibus e", "View Files as Values behavior does not match v8.4")
