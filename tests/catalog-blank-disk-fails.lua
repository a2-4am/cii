...
--[[
  This tests that C2Reboot displays an error message when attempting to catalog a blank (formatted but all-0s) disk, matching v8.4 behavior.
]]
...
test.Step(
  "Catalog blank disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
