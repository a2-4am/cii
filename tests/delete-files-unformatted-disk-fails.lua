...
--[[
  This tests that C2Reboot displays an error message when attempting to delete files on an unformatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "Delete Files on unformatted disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
