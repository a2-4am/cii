...
--[[
  This tests that C2Reboot displays an error message when attempting to catalog an unformatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "Catalog unformatted disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
