...
--[[
  This tests that C2Reboot displays an error message when attempting to view files as text on an unformatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "View Files as Text on unformatted disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
