...
--[[
  This tests View Files as Text on a SYS file from a ProDOS formatted disk, matching v8.4 behavior.
]]
...
test.Step(
  "View Files as Text on SYS file (ProDOS) matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
    ...
    test.ExpectIMatch(apple2.GrabTextScreen(), "393", "View Files as Text behavior does not match v8.4") -- visible byte offset
    test.ExpectIMatch(apple2.GrabTextScreen(), "LG NNASTARTUP", "View Files as Text behavior does not match v8.4")
