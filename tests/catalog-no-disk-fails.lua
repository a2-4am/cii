...
--[[
  This tests that C2Reboot displays an error message when attempting to catalog a non-existent disk, matching v8.4 behavior.
]]
...
test.Step(
  "Catalog non-existent disk fails, matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
