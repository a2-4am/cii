...
--[[
  This tests Unlock Files on a ProDOS disk. The operation should succeed, matching v8.4 behavior. The final disk image should be identical to one where the same operation was performed by v8.4.
]]
...
--[[ BEGINCONFIG ========================================
  ...
  DISKARGS="-flop1 'beagle-graphics-unlocked-by-v84.do' -flop3 $FLOPIMG -flop4 'beagle-graphics.do'"
...
test.Step(
  "Unlock Files (ProDOS) matches v8.4 behavior",
  function()
    cii.WaitForMainMenu()
