...
$(EXE): $(MMX7) $(FILERX) $(COPYX7) $(CATALOGX7) $(DELETEX7) $(FORMATX7) $(VERIFYX7) $(VIEWX7) $(DISKMAPX7) $(CHANGEBOOTX7) $(UNDELETEX7) $(MAKESUBX7) $(QUITX7) $(SETCLOCKX) $(MMVARS) $(FILERVARS) $(COPYVARS) $(CATALOGVARS) $(DELETEVARS) $(FORMATVARS) $(VERIFYVARS) $(VIEWVARS) $(DISKMAPVARS) $(CHANGEBOOTVARS) $(UNDELETEVARS) $(MAKESUBVARS) $(QUITVARS) $(SETCLOCKVARS) $(BUILDDIR)
...
#
# Make Subdirectory module (requires Filer)(compressed)(self-decompressing)
#
