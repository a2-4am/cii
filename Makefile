...
$(EXE): $(MMX7) $(FILERX) $(COPYX7) $(CATALOGX7) $(DELETEX7) $(VERIFYX7) $(VIEWX7) $(DISKMAPX7) $(UNDELETEX7) $(QUITX7) $(SETCLOCKX) $(MMVARS) $(FILERVARS) $(COPYVARS) $(CATALOGVARS) $(DELETEVARS) $(VERIFYVARS) $(VIEWVARS) $(DISKMAPVARS) $(UNDELETEVARS) $(QUITVARS) $(SETCLOCKVARS) $(BUILDDIR)
