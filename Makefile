...
$(EXE): $(MMX7) $(PHRWTSX7) $(MESSAGES2X7) $(FILERX) $(CATLIBX7) $(DODEVX7) $(DOTREEX7) $(COPYX7) $(CATALOGX7) $(DELLIBX7) $(VERIFYX7) $(DISKMAPX7) $(UNDELETEX7) $(MISCLIBX7) $(MMVARS) $(PHRWTSVARS) $(READLIBVARS) $(FILERVARS) $(CATLIBVARS) $(DODEVVARS) $(DOTREEVARS) $(COPYVARS) $(CATALOGVARS) $(DELLIBVARS) $(VERIFYVARS) $(DISKMAPVARS) $(UNDELETEVARS) $(MISCLIBVARS) $(BUILDDIR)
...
#
$(FILERO): $(MMVARS) $(BOOTSEC33VARS) $(PHRWTSVARS) $(MESSAGES2VARS) $(IOVARS) $(READLIBVARS) $(DISKLIBVARS)
