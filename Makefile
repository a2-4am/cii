...
$(EXE): $(MMX7) $(FILERX) $(COPYX7) $(CATALOGX7) $(VERIFYX7) $(DISKMAPX7) $(QUITX7) $(SETCLOCKX) $(MMVARS) $(FILERVARS) $(COPYVARS) $(CATALOGVARS) $(VERIFYVARS) $(DISKMAPVARS) $(QUITVARS) $(SETCLOCKVARS) $(BUILDDIR)
