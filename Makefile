...
$(EXE): $(MMX7) $(PHRWTSX7) $(FILERX) $(RDDATAX7) $(CATLIBX7) $(DODEVX7) $(DOTREEX7) $(COPYX7) $(CATALOGX7) $(DELLIBX7) $(VERIFYX7) $(DISKMAPX7) $(UNDELETEX7) $(MISCLIBX7) $(MMVARS) $(PHRWTSVARS) $(FILERVARS) $(RDDATAVARS) $(CATLIBVARS) $(DODEVVARS) $(DOTREEVARS) $(COPYVARS) $(CATALOGVARS) $(DELLIBVARS) $(VERIFYVARS) $(DISKMAPVARS) $(UNDELETEVARS) $(MISCLIBVARS) $(BUILDDIR)
...
#
$(FILERO): $(MMVARS) $(PHRWTSVARS) $(BOOTSEC33VARS)
