...
$(EXE): $(MMX7) $(FILERX) $(COPYX7) $(CATALOGX7) $(DISKMAPX7) $(QUITX7) $(SETCLOCKX) $(MMVARS) $(FILERVARS) $(COPYVARS) $(CATALOGVARS) $(DISKMAPVARS) $(QUITVARS) $(SETCLOCKVARS) $(BUILDDIR)
...
#
$(DISKMAPO): $(FILERVARS) $(CATALOGVARS)
