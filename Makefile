...
APPLIBO=$(BUILDDIR)/APPLIB.O
APPLIBX7=$(BUILDDIR)/APPLIB.X7
APPLIBVARS=$(BUILDDIR)/APPLIB.VARS.S
...
$(EXE): $(MMX7) $(PHRWTSX7) $(MESSAGES2X7) $(FILERX) $(LINEINPUTX7) $(UILIBX7) $(TREELIBX7) $(DISKLIBX7) $(CATLIBX7) $(COPYX7) $(CATALOGX7) $(DELLIBX7) $(APPLIBX7) $(MISCLIBX7) $(MMVARS) $(PHRWTSVARS) $(BOOTSEC33VARS) $(FILERVARS) $(LINEINPUTVARS) $(UILIBVARS) $(TREELIBVARS) $(DISKLIBVARS) $(CATLIBVARS) $(COPYVARS) $(CATALOGVARS) $(DELLIBVARS) $(APPLIBVARS) $(MISCLIBVARS) $(BUILDDIR)
...
$(LINEINPUTX7): $(LINEINPUTO)
	$(call X7,$(LINEINPUTO),6)
...
# Filer (compressed)
#
$(FILERO): $(PHRWTSVARS) $(MESSAGES2VARS) $(MESSAGESVARS) $(DRIVE35VARS) $(PRODOSVARS) $(IOVARS) $(MENUVARS) $(ERRORSVARS) $(QUITVARS)
...
#
# APPLIB module (compressed)(self-decompressing)
# contains Verify, Map Disk, Undelete
#
$(APPLIBO): $(PRODOSVARS) $(IOVARS) $(ERRORSVARS) $(UILIBVARS) $(DISKLIBVARS) $(CATLIBVARS) $(TREELIBVARS) $(DISKMAPVARS) $(CATALOGVARS)
	$(MERLIN) "$(SRCDIR)"/APPLIB.S > "$(BUILDLOG)"
	$(call POSTMERLIN)

$(APPLIBVARS): $(APPLIBO)
	$(call VARS,/;APPLIB.S;/,$(APPLIBO))

$(APPLIBX7): $(APPLIBO)
	$(call X7,$(APPLIBO),3)

#
# MISCLIB module (compressed)(self-decompressing)
# contains several less-common features like
# Make Subdirectory, Change Boot Program, Alphabetize Catalog, &c.
#
$(MISCLIBO): $(PRODOSVARS) $(IOVARS) $(ERRORSVARS) $(LINEINPUTVARS) $(UILIBVARS) $(DISKLIBVARS) $(CATLIBVARS) $(TREELIBVARS) $(APPLIBVARS)
