...
$(EXE): $(MMX7) $(FILERX) $(DODEVX7) $(DDISKX7) $(D1FILEX7) $(DOTREEX7) $(COPYX7) $(CATALOGX7) $(DELETEX7) $(ALPHABETIZEX7) $(FORMATX7) $(VERIFYX7) $(VIEWX7) $(DISKMAPX7) $(CHANGEBOOTX7) $(UNDELETEX7) $(MAKESUBX7) $(QUITX7) $(SETCLOCKX) $(MMVARS) $(FILERVARS) $(DODEVVARS) $(DDISKVARS) $(D1FILEVARS) $(DOTREEVARS) $(COPYVARS) $(CATALOGVARS) $(DELETEVARS) $(ALPHABETIZEVARS) $(FORMATVARS) $(VERIFYVARS) $(VIEWVARS) $(DISKMAPVARS) $(CHANGEBOOTVARS) $(UNDELETEVARS) $(MAKESUBVARS) $(QUITVARS) $(SETCLOCKVARS) $(BUILDDIR)
