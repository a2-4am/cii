...
SETCLOCKX7=$(BUILDDIR)/SETCLOCK.X7
...
$(EXE): $(MMX7) $(FILERX) $(RDDATAX7) $(CATLN1X7) $(MATCHX7) $(DODEVX7) $(DDISKX7) $(D1FILEX7) $(DOTREEX7) $(COPYX7) $(CATALOGX7) $(DELETEX7) $(ALPHABETIZEX7) $(FORMATX7) $(VERIFYX7) $(VIEWX7) $(DISKMAPX7) $(CHANGEBOOTX7) $(UNDELETEX7) $(MAKESUBX7) $(SETCLOCKX7) $(QUITX7) $(MMVARS) $(FILERVARS) $(RDDATAVARS) $(CATLN1VARS) $(MATCHVARS) $(DODEVVARS) $(DDISKVARS) $(D1FILEVARS) $(DOTREEVARS) $(COPYVARS) $(CATALOGVARS) $(DELETEVARS) $(ALPHABETIZEVARS) $(FORMATVARS) $(VERIFYVARS) $(VIEWVARS) $(DISKMAPVARS) $(CHANGEBOOTVARS) $(UNDELETEVARS) $(MAKESUBVARS) $(SETCLOCKVARS) $(QUITVARS) $(BUILDDIR)
...
#
# Set Clock module (requires Filer)(compressed)(self-decompressing)
#
$(SETCLOCKO): $(FILERVARS) $(MAKESUBVARS)
