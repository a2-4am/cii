...
$(EXE): $(MMX7) $(FILERX) $(RDDATAX7) $(CATLIBX7) $(DODEVX7) $(DOTREEX7) $(COPYX7) $(CATALOGX7) $(DELLIBX7) $(ALPHABETIZEX7) $(VERIFYX7) $(VIEWX7) $(DISKMAPX7) $(CHANGEBOOTX7) $(UNDELETEX7) $(MAKESUBX7) $(SETCLOCKX7) $(QUITX7) $(MMVARS) $(FILERVARS) $(RDDATAVARS) $(CATLIBVARS) $(DODEVVARS) $(DOTREEVARS) $(COPYVARS) $(CATALOGVARS) $(DELLIBVARS) $(ALPHABETIZEVARS) $(VERIFYVARS) $(VIEWVARS) $(DISKMAPVARS) $(CHANGEBOOTVARS) $(UNDELETEVARS) $(MAKESUBVARS) $(SETCLOCKVARS) $(QUITVARS) $(BUILDDIR)
...
#
$(ALPHABETIZEO): $(FILERVARS) $(DELLIBVARS)
...
#
$(VERIFYO): $(FILERVARS) $(ALPHABETIZEVARS)
